    ...
    <div className="min-h-screen bg-canvas py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <button
                ...
                className="bg-pes hover:bg-pes-700 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors"
              >
                Add Task
              </button>
            </div>
            ...
            <div className="space-y-4">
              {historicalTasks.map((task) => (
                <div key={task.id} className="border border-line rounded-md p-4">
                  <div className="flex justify-between items-start mb-3">
                    <input
                      ...
                      className="flex-1 mr-2 px-3 py-2 border border-line rounded-md focus:outline-none focus:ring-2 focus:ring-pes"
                    />
                    <button
            ...
            {historicalTasks.length > 0 && (
              <div className="mt-6 p-4 bg-pes-50 rounded-md">
                <h3 className="font-medium text-blue-900 mb-2">Summary</h3>
                <p className="text-pes-700">
          ...
          {/* New Task Estimation */}
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-xl font-semibold text-strong mb-4">
              New Task Estimation
            </h2>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="bg-canvas rounded-md p-4">
                <h4 className="font-medium text-strong mb-2">Calculation Steps:</h4>
                <div className="text-xs text-body space-y-1 font-mono">
          ...
          <div className="prose prose-sm text-body">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
              ...
              <div className="bg-purple-50 p-4 rounded-md">
                <h3 className="font-medium text-strong mb-2">Step 3: Final Adjustments</h3>
