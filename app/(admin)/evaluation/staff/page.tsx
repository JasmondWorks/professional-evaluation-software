...
export default function Home() {
    ...
    function handleEvaluate(event: { preventDefault: () => void }) {
        ...
        // Validation
        if (numberDataEntry.available_hours <= 0 || numberDataEntry.use_factor <= 0) {
            ...
            <div className="p-2">
                ...
                <div>
                    {arrayDataEntry.observed_time.map((_, index) => (
                        <div key={index} className="flex flex-col border-b border-gray-100 pb-8 mb-8 last:border-0 last:pb-0">
                            ...
                            <div className="flex flex-wrap gap-y-4">
                                <label className="flex flex-col w-72">
                                    <span className="text-sm font-medium text-gray-600 mb-1">Observed time</span>
                                    <input required className="border border-gray-300 me-6 px-4 py-2.5 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" type="number" value={arrayDataEntry.observed_time[index] || ""} onChange={(e) => handleDataEntry(e, index, "observed_time")} />
                                </label>

                                <label className="flex flex-col w-72">
                                    <span className="text-sm font-medium text-gray-600 mb-1">Observed rating (0 - 200)</span>
                                    <input required className="border border-gray-300 me-6 px-4 py-2.5 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" type="number" value={arrayDataEntry.rating[index] || ""} onChange={(e) => handleDataEntry(e, index, "rating")} />
                                </label>

                                <label className="flex flex-col w-72">
                                    <span className="text-sm font-medium text-gray-600 mb-1">Relaxation time</span>
                                    <input required className="border border-gray-300 me-6 px-4 py-2.5 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" type="number" value={arrayDataEntry.relaxation_time[index] || ""} onChange={(e) => handleDataEntry(e, index, "relaxation_time")} />
                                </label>

                                <label className="flex flex-col w-72">
                                    <span className="text-sm font-medium text-gray-600 mb-1">Contingency allowance</span>
                                    <input required className="border border-gray-300 me-6 px-4 py-2.5 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" type="number" value={arrayDataEntry.contingency_time[index] || ""} onChange={(e) => handleDataEntry(e, index, "contingency_time")} />
                                </label>

                                <label className="flex flex-col w-72">
                                    <span className="text-sm font-medium text-gray-600 mb-1">Number of workers</span>
                                    <input required className="border border-gray-300 me-6 px-4 py-2.5 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" type="number" value={arrayDataEntry.number_of_workers[index] || ""} onChange={(e) => handleDataEntry(e, index, "number_of_workers")} />
                                </label>

                                <label className="flex flex-col w-72">
                                    <span className="text-sm font-medium text-gray-600 mb-1">Annual frequency</span>
                                    <input required className="border border-gray-300 me-6 px-4 py-2.5 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" type="number" value={arrayDataEntry.annual_frequency[index] || ""} onChange={(e) => handleDataEntry(e, index, "annual_frequency")} />
                                </label>
                            </div>
                        </div>
                    ))}
