...
export default function UnitHeadOverloadingPage() {
  ...
  const saveResult = async () => {
    if (!result) return notify.error("Please calculate before saving");
    ...
    <div className="p-8 w-full mx-auto">
      ...
      <div className="flex justify-between items-start mb-8">
        ...
        <div className="flex gap-3">
          ...
          >
            <svg className="w-4 h-4 text-muted" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl border border-line p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-line">
            ...
            <div>
              <h2 className="text-lg font-bold text-strong">Supervisory Parameters</h2>
              <p className="text-xs text-muted">Current actual supervisory workload</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl border border-line p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-line">
            ...
            <div>
              <h2 className="text-lg font-bold text-strong">Constants & Optimization</h2>
              <p className="text-xs text-muted">Factors influencing complexity and baseline bounds</p>
            </div>
          </div>
          <div className="grid grid-cols-1 gap-6">
            <div className="block w-full min-w-0">
        ...
        <div className="mt-8 border-t border-line pt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <div className="bg-white rounded-xl border border-line p-6 shadow-sm flex flex-col justify-center">
              <p className="text-sm font-medium text-muted mb-1">Complexity Factor (CF)</p>
              <p className="text-3xl font-bold text-strong">{result.CF.toFixed(3)}</p>
            </div>

            <div className="bg-white rounded-xl border border-line p-6 shadow-sm flex flex-col justify-center">
              <p className="text-sm font-medium text-muted mb-1">Overload Ratio (OR)</p>
