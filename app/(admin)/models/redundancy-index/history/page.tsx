...
export default function RedundancyHistoryPage() {
  ...
  useEffect(() => {
    async function fetchHistory() {
      try {
        ...
        const res = await apiFetch("/api/getPersonnelIndex?type=redundancy", {
          method: "GET",
          headers: {
  ...
  return (
    <div className="p-8 w-full mx-auto">
      <div className="mb-8">
        <BackLink href="/models/redundancy-index" className="mb-4">Back to Model</BackLink>
      ...
      {error ? (
        ...
        <div className="bg-white border rounded-xl p-12 text-center shadow-sm">
          ...
          <p className="text-muted">You haven't saved any Redundancy Index results yet.</p>
        </div>
      ) : (
