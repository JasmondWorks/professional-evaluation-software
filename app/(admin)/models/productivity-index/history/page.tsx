...
export default function ProductivityHistoryPage() {
  ...
  useEffect(() => {
    async function fetchHistory() {
      try {
        ...
        const res = await fetch("/api/getPersonnelIndex?type=productivity", {
          method: "GET",
          headers: {
  ...
  return (
    <div className="p-8 w-full mx-auto">
      <div className="mb-8">
        <Link
          href="/models/productivity-index"
      ...
      {error ? (
        ...
        <div className="bg-white border rounded-xl p-12 text-center shadow-sm">
          ...
          <p className="text-gray-500">You haven't saved any Productivity Index results yet.</p>
        </div>
      ) : (
