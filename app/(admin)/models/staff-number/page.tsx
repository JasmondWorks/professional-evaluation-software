      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl border border-line p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-line">
            ...
            <div>
              <h2 className="text-lg font-bold text-strong">Task Volume & Time</h2>
              <p className="text-xs text-muted">Core parameters defining the workload</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl border border-line p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-line">
            ...
            <div>
              <h2 className="text-lg font-bold text-strong">Modifiers & Availability</h2>
              <p className="text-xs text-muted">Factors adjusting the raw time estimate</p>
            </div>
          </div>
          <div className="flex gap-2 mb-6">
            <Link
              ...
              className="text-xs px-3 py-1.5 bg-canvas text-body rounded hover:bg-gray-200"
            >
              📄 Relaxation Guide
            </Link>
            <Link
