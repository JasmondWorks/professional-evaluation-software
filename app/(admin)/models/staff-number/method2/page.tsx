      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900">Time Estimations</h2>
              <p className="text-xs text-gray-500">Observed and reported time metrics</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900">Modifiers & Load</h2>
              <p className="text-xs text-gray-500">Factors and volumes affecting the estimate</p>
            </div>
          </div>
          <div className="grid grid-cols-1 gap-6">
            <div className="block w-full min-w-0">
