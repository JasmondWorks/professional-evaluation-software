...
export default function StaffEstimationHistoryPage() {
  ...
  return (
    <div className="p-8 w-full mx-auto">
      <div className="mb-8">
        <BackLink href="/models/staff-number" className="mb-4">Back to Staff Number Model</BackLink>
      ...
      {error ? (
        ...
        <div className="bg-white border rounded-xl p-12 text-center shadow-sm">
          ...
          <p className="text-muted">You haven't saved any Staff Estimation results yet.</p>
        </div>
      ) : (
              ...
              <tbody className="divide-y divide-line">
                {runs.map((run) => (
                  <tr key={run.id} className="hover:bg-canvas transition-colors">
                    ...
                    <td className="px-6 py-4 text-muted text-xs truncate max-w-xs">
