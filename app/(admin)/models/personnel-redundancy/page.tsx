  ...
  return (
    <div className="p-8 w-full mx-auto">
      ...
      <div className="flex justify-between items-start mb-8">
        ...
        <div className="flex gap-3">
          <Link
            ...
            className="bg-pes text-white px-4 py-2 rounded-md hover:bg-blue-900 font-medium text-sm transition-colors flex items-center gap-2"
          >
            Utilization Table
          </Link>
          <Link
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900">Staff Configuration</h2>
              <p className="text-xs text-gray-500">Current and theoretical staff counts</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900">Redundancy Thresholds</h2>
              <p className="text-xs text-gray-500">Boundaries for classifying redundancy severity</p>
            </div>
          </div>
          <div className="grid grid-cols-1 gap-6">
            <div className="block w-full min-w-0">
      ...
      <button
        ...
        className={`px-4 py-2 rounded text-white ${actualStaff > 0 && optimalStaff > 0 ? "bg-pes hover:bg-blue-900" : "bg-gray-400 cursor-not-allowed"}`}
      >
        ...
        <div className="mt-8 border-t border-gray-200 pt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-500 mb-1">Percentage Redundancy (PR%)</p>
