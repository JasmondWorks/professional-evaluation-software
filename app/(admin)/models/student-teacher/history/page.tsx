...
export default function StudentTeacherHistoryPage() {
  const [runs, setRuns] = useState<StudentTeacherRun[]>([]);
  ...
  useEffect(() => {
    async function fetchHistory() {
      try {
        ...
        const res = await apiFetch("/api/getStudentTeacherRatio", {
          method: "GET",
          headers: {
    ...
    <div className="p-8 w-full mx-auto">
      ...
      {error ? (
        ...
        <div className="bg-white border rounded-xl p-12 text-center shadow-sm">
          ...
          <p className="text-muted">You haven't saved any Student-Teacher ratio results yet.</p>
        </div>
      ) : (
