...
export const tabs = [
  ...
  { key: 3, name: "Data Entry", icon: <Home3 />, href: "/data-entry", role_access: ["lecturer", "industrial-engineer", "hod", "departmental-admin", "unit-head", "employee-w", "auditor"] },
  ...
  { key: 2, name: "Profile", icon: <ProfileCircle />, href: "/profile", role_access: ["lecturer", "industrial-engineer", "hod", "departmental-admin", "unit-head", "employee-w", "auditor"] },
  ...
  { key: 31, name: "Appraisal forms", icon: <Home3 />, href: "/appraisal", role_access: ["lecturer", "industrial-engineer", "hod", "departmental-admin", "unit-head", "employee-w", "auditor"] },
