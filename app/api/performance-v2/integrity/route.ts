...
import { runPerformanceIntegrity } from '@/app/lib/performance/service';
import { fail, viewerFrom } from '../_auth';

/** The data integrity test over one performance period, every department at once.
...
export async function GET(req: Request) {
  try {
    ...
    return NextResponse.json({ report: await runPerformanceIntegrity(viewer, periodId) });
