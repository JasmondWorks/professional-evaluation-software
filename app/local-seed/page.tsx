...
export default function LocalSeedPage() {
  ...
  const availableRoles = PRESET_ROLES.filter(
    (r) => r !== "lecturer" || category === "academic",
  );
  ...
  if (status === "seeded") {
    ...
    return (
      <div className="max-w-2xl mx-auto px-4 py-10">
        <PageHeader
          title="Local seed"
          subtitle="This database already has an organization."
        />
        <Card className="p-6 flex flex-col gap-4">
          {result ? (
            ...
            <p className="text-sm text-body">
              Seeding only ever runs once. These are the details from when it
              ran.
            </p>
          )}
          ...
          {credentialsText ? (
            <div className="flex flex-col gap-1.5">
              <p className="text-xs font-medium text-muted">
                Also saved to <code>LOCAL_SEED_CREDENTIALS.md</code> in the
                project root.
              </p>
            ...
            <p className="text-sm text-muted">
              No saved credentials file was found — this org may have been
              seeded another way.
            </p>
          )}
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted mt-0.5">
                Optional — skip this and add employees later as the admin, from
                within the app.
              </p>
            </div>
            <Button
                ...
                >
                  ...
                  <div className="grid sm:grid-cols-3 gap-3">
                    ...
                    <Input
                      ...
                      value={row.dept}
                      onChange={(e) =>
                        updateEmployee(row.key, { dept: e.target.value })
                      }
                    />
                    <div className="flex flex-col gap-1.5">
